...
#    mp.rename(columns={'name':'Kabupaten/Kota'}, inplace=True)
    ...
    fig = px.scatter_mapbox(mp, lat="latitude", lon="longitude", color="Kabupaten/Kota", hover_data=[ "jumlah penduduk", "periode update"], size="jumlah penduduk", width=1100, size_max=200)
